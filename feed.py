...
with open('feed.yaml','r') as file:
    ...
    for item in yaml_data['item']:
        ...
        xml_tree.SubElement(item_element, 'enclousre', {
    ...
    rough_string = xml_tree.tostring(rss_element, encoding='utf-8')
    dom = xml.dom.minidom.parseString(rough_string)

    # Pretty print with indentation and save to 'podcast.xml'
